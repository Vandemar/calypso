!>@file   set_vr_rtm_for_leg_cuda.f90
!!@brief  module set_vr_rtm_for_leg_cuda
!!
!!@author H. Matsui
...
! -----------------------------------------------------------------------
!
      subroutine set_vr_rtm_vector_cuda(k, nvector, n,                  &
     &         mp_rlm, mn_rlm, ncomp, irev_sr_rtm, n_WR, WR,            &
     &         nvec_kl, symp_r, asmp_t, asmp_p, symn_t, symn_p)
!
      use m_work_4_sph_trans
!
      integer(kind = kint), intent(in) :: k, nvector, n
...
!          asin_rtm = asin_theta_1d_rtm(l_rtm)
       ...
       &               + (mn_rlm-1) * istep_rtm(3)
            ...
            i_kl = 1 + (k_rlm-1) + nidx_rtm(1) * (l_rtm-1) +            &
       &           nidx_rtm(1)*nidx_rtm(2)*(nd-1) +                         &
       &           nidx_rtm(1)*nidx_rtm(2)*nvector*(n-1)
...
!
      end subroutine set_vr_rtm_vector_cuda
!
! -----------------------------------------------------------------------
!
      subroutine set_vr_rtm_scalar_cuda(kst, nkr, mp_rlm,             &
...
!
      end subroutine set_vr_rtm_scalar_cuda
!
! -----------------------------------------------------------------------
! -----------------------------------------------------------------------
!
...
!
      end subroutine set_vr_rtm_vector_sym_cuda
!
! -----------------------------------------------------------------------
!
      subroutine set_vr_rtm_scalar_sym_cuda                           &
...
!
      end subroutine set_vr_rtm_scalar_sym_cuda
!
! -----------------------------------------------------------------------
!
      end module set_vr_rtm_for_leg_cuda
