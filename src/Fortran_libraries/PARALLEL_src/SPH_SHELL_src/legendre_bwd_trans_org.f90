...
! -----------------------------------------------------------------------
!
      subroutine legendre_b_trans_vector_org_4_cuda                     &
     &         (ncomp, nvector, sp_rlm, vr_rtm, order)
!
      integer(kind = kint), intent(in) :: ncomp, nvector, order
      real(kind = kreal), intent(inout) :: sp_rlm(ncomp*nnod_rlm)
      real(kind = kreal), intent(inout) :: vr_rtm(ncomp*nnod_rtm)
!
      integer(kind = kint) :: ip_rtm, in_rtm, i_rlm, j_rlm
...
!$omp end parallel do
!
      end subroutine legendre_b_trans_vector_org_4_cuda
!
! -----------------------------------------------------------------------
!
      subroutine legendre_b_trans_scalar_org                            &
